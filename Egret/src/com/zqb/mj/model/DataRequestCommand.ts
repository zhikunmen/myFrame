module PKGame {
	export class DataRequestCommand extends puremvc.SimpleCommand{
		...
		public  execute(notification: puremvc.INotification): void {
			 var socketProxy: PKGame.ServerPKProxy = this.facade.retrieveProxy(PKGame.ServerPKProxy.NAME) as PKGame.ServerPKProxy;
			 ResUtil.trace("execute:",notification.getType());
